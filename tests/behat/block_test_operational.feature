...
Feature: Test the complete sequence of operational steps for a block
  ...
  Scenario: Testing the complete sequence of operational steps for an activity module
    ...
    And I add the "Enrollments And Transcripts" block
    Then I should see "Current Enrollments" in the "Enrollments And Transcripts" "block"
    When I backup "Test Course" course using this options:
      | Confirmation | Filename | test_backup.mbz |
    And I restore "test_backup.mbz" backup into a new course using this options:
      | Schema | Course name | Test Restored Course |
    Then I should see "Current Enrollments" in the "Enrollments And Transcripts" "block"
    When I open the "Enrollments And Transcripts" blocks action menu
    And I click on "Delete" "link" in the "Enrollments And Transcripts" "block"
    And I press "Yes"
    And I turn editing mode off
    Then I should not see "Enrollments And Transcripts"
